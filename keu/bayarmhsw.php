...
function TampilkanHeaderBayar() {
    ...
    if ($khs['PrintTagihan'] >= 1) {
        $TombolResetPrintTagihan = ($_SESSION['_LevelID'] == 1) ? "<input type=button name='ResetPrintTagihan' value='Reset' onClick=\"javascript:KonfResetPrintTagihan('$khs[KHSID]')\" />" : "";
    } else {
    ...
    <tr><td class=wrn width=2></td>
        ...
        <td class=ul1 width=100><input type=text name='TahunID' value='$_SESSION[TahunID]' size=5 maxlength=10 /></td>
...
function TampilkanHeaderMhsw($mhsw, $khs) {
    ...
    if ($khs['PrintTagihan'] >= 1) {
        ...
        $TombolTambahBipot = "<input type=button name='TambahBipot' value='Tambah Bipot' onClick=\"javascript:BIPOTEdit('$mhsw[MhswID]', '$khs[TahunID]', 1, 0)\" style='color:red;font-weight:bold' />";
    ...
    $TombolHapusSemuaBipot
    $TombolTambahBipot
    <input type=button name='TambahBayar' value='Tambah Pembayaran' onClick="javascript:ByrEdit('$mhsw[MhswID]', $khs[KHSID], 1, '')" style='color:yellow;font-weight:bold' />
    ...
    while ($w = _fetch_array($r)) {
        ...
        if ($_SESSION['_LevelID'] == 1 || $_SESSION['_LevelID'] == 70) { // hanya superuser atau ka. keu
            if ($khs['PrintTagihan'] >= 1) {
                ...
                if ($byrm_jml > $byrm2['Jumlah']) { // Jumlah pembayaran dari gabungan dua biaya, tidak bisa edit tapi bisa delete
                    $edit = "";
                } else {
        ...
        <td class=ul1>$ctt&nbsp;</td>
        <td class=ul1 align=center width=10>$del</td>
      </tr>";
    }
